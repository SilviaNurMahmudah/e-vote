          ...
          var myChart = new Chart(ctx, {
            ...
            data: {
              ...
              datasets: [{
                ...
                ?>,
                <?php 
                $paslon4 = mysqli_query($koneksi,"select * from tbl_paslon where nomor_paslon='3'");
...
<div class="footer">
  <div class="row">
    <div class="col-lg-12" >
      &copy; MI-2F Kelompok 5 <?php echo date('Y') ?> <a href="http://binarytheme.com" style="color:#fff;" target="_blank"></a>
    </div>
  </div>
</div>
